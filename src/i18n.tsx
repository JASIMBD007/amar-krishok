...
const bn: Record<string, string> = {
  ...
  "Backend service is unavailable. Please try again.": "ব্যাকএন্ড সার্ভিস পাওয়া যাচ্ছে না। একটু পরে আবার চেষ্টা করুন।",
  ...
  "Upload NID or trade license": "NID বা ট্রেড লাইসেন্স আপলোড করুন",
  "Loading profile": "প্রোফাইল লোড হচ্ছে",
  "Profile details synced with backend": "প্রোফাইল তথ্য ব্যাকএন্ডে সিঙ্ক আছে",
  ...
  "NID / trade license image": "NID / ট্রেড লাইসেন্স ছবি",
  "Existing document kept": "আগের ডকুমেন্ট রাখা হবে",
  "Choose an image or PDF": "ছবি বা PDF বেছে নিন",
  "Please choose a file to upload.": "আপলোড করার জন্য একটি ফাইল বেছে নিন।",
  "Document must be an image or PDF.": "ডকুমেন্টটি ছবি বা PDF হতে হবে।",
  ...
  "Manage your crop lots, backend listings, and admin support from one place.": "ফসলের লট, ব্যাকএন্ডে প্রকাশিত তালিকা আর অ্যাডমিন সাপোর্ট এক জায়গা থেকে সামলান।",
  ...
  "Seller backend metrics": "বিক্রেতার ব্যাকএন্ড হিসাব",
  "Active backend lots": "সক্রিয় ব্যাকএন্ড লট",
  ...
  "Backend connected": "ব্যাকএন্ড যুক্ত",
  ...
  "Published to backend.": "ব্যাকএন্ডে প্রকাশ হয়েছে।",
  "Backend lots": "ব্যাকএন্ড লট",
  "Your published crop lots": "আপনার প্রকাশিত ফসলের লট",
  "Loading your backend lots...": "আপনার ব্যাকএন্ড লট লোড হচ্ছে...",
  "No backend lots posted yet.": "এখনো কোনো ব্যাকএন্ড লট দেওয়া হয়নি।",
  ...
  SOLD: "বিক্রি হয়েছে",
  CANCELLED: "বাতিল",
  "Please sign in again to post a backend lot.": "ব্যাকএন্ডে লট দিতে আবার লগইন করুন।",
  ...
  "Track the lots already sent to the marketplace. Order changes stay read-only for farmers.": "মার্কেটপ্লেসে পাঠানো লটগুলো এখানে দেখুন। অর্ডারের পরিবর্তন কৃষকের জন্য শুধু দেখার মতো থাকবে।",
  ...
  "Buyer backend metrics": "ক্রেতার ব্যাকএন্ড হিসাব",
  ...
  "Protected by backend login": "ব্যাকএন্ড লগইন দিয়ে সুরক্ষিত",
  ...
  "Backend orders": "ব্যাকএন্ড অর্ডার",
  ...
  "No backend orders yet.": "এখনো কোনো ব্যাকএন্ড অর্ডার নেই।",
  ...
  "Order request sent to backend.": "অর্ডার অনুরোধ ব্যাকএন্ডে পাঠানো হয়েছে।",
