...
type AdminSection = "dashboard" | "orders" | "supply" | "farmers" | "logistics" | "payouts" | "settings";
type Language = "en" | "bn";
...
const adminNavItems: Array<{ id: AdminSection; label: string; icon: typeof LayoutDashboard }> = [
